...
foreach ($testName in @(
    ...
    'expedition_test', 'expedition_ui_test', 'skill_visual_test', 'keyboard_forge_test', 'keyboard_ui_test', 'painted_art_test', 'refinement_test', 'vanguard_test', 'practice_meter_test', 'cursor_test', 'interface_polish_test', 'loot_receipt_test', 'pressure_feedback_test', 'run_diagnostics_test', 'review_rules_test', 'operation_test', 'balance_benchmark_test', 'level_progression_test', 'support_art_test', 'combo24_test', 'mosquito25_test', 'arsenal26_test'
)) {
