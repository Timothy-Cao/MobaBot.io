...
The sections below retain the 0.18 and earlier compatibility details. Where they differ, the 0.19.1 rules above and linked specifications govern new expeditions. Saved runs without `unified_mastery` retain their old tree.
...
New expeditions use the fixed **Vanguard** kit and paused core skill progression. The 22-round route, 13-node run mastery tree, eight equipment slots × five tiers, shops, Ascensions 0–5 and cleared-round checkpoints remain. Existing checkpoints retain their original progression rather than losing learned skills. Legacy abilities remain in Practice. Marshal, Racer and offline progression are not implemented.
