	...
	match game.practice_page:
		...
		"Player":
			for i in range(5):
				...
				toggle.name=field
		"Enemies":
			var types: Array=["dummy","bumper","charger","tank","breacher","mender","scatter","lancer","volley","bomber","rammer","artillery","foreman"]
			PracticeView.select(ui,["Target dummy","Bumper","Charger","Tank","Breacher","Mender","Scattergun","Arc lancer","Burst battery","Bomb carrier","Rammer","Artillery","Boss"],types.find(game.practice_enemy),Rect2(26,173,278,33),func(i): game.practice_enemy=types[i])
