		...
		"Build":
			...
			for i in range(3):
				...
				ui._button(str(rank_value),Rect2(26+i*95,218,88,35),func():
					...
					ReviewRules.enable(game.model); LevelMastery.enable(game.model); game.model.kit.loadout.support23=true; game.model.kit.loadout.arsenal26=true
					if rank_value>=10: game.model.kit.charges.e=4
