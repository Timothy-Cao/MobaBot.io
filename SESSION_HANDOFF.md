...
- Latest owner feedback says the player hull bar is too small. Future hypotheses also pair a gradually mouse-guided hold-Q with restored wall collision for discrete friendly/hostile projectiles. These are documented in `GAMEPLAY_VISION_18.md`; neither is implemented in the frozen build.
