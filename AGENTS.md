...
- Run scripts/check.ps1 for final regression. Use both behavior probes to compare passive-only, naive casting and adaptive play. Human feel is not established by a passing bot. Mastery is run-only; main-menu previews cannot spend points.
