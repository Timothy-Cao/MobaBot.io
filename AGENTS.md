...
Read README.md, docs/design/QA_13.md and docs/design/SYSTEMS_REFINEMENT_12.md for current controls, scope and handoff. Older iteration documents are historical.
