...
- [Ability direction and owner feedback](design/ABILITY_FEEDBACK_17.md) — description-based notes for abilities 1–11, fixed slot identities, non-modal learn/upgrade progression, learned loadouts and detailed default D/F behavior including buffered post-blink casts and thick-terrain traversal. These are future design inputs, not current implemented behavior.
